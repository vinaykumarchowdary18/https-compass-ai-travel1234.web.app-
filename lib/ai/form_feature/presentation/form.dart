...
import 'package:compass/ai/map_feature/map_feature.dart';
...
class _FormScreenState extends State<FormScreen> {
  ...
  void generateItineraries() async {
    ...
    try {
      // Make sure there's a user-inputed prompt and location
  ...
  Future<void> _updateLocationName(LatLng location) async {
    ...
    setState(() {
      _locationName = '${location.latitude.toStringAsFixed(4)}, ${location.longitude.toStringAsFixed(4)}';
    });
  }
